...
LifeOS is not built in isolation. It stands explicitly on three historical foundations:

1. **The Web architecture** (URI, HTTP, HTML)
2. **The Semantic Web stack** (RDF → Logic → Proof → Trust)
3. **Solid / POD architecture** (data sovereignty and access control)

These layers answer different, complementary questions:

| Reference | What it answers | Where it stops |
|-----------|-----------------|----------------|
| Web | How documents and services are addressed and transported | Does not define cognitive state or responsibility |
| Semantic Web | How data, logic, and proof are represented | Stops before human-facing explanation and temporal coherence |
| Solid | Where data lives and who controls access | Stops before cognitive continuity and agents |

LifeOS does **not** replace these layers. It extends them with:

- `.life` documents as a canonical, URI-shaped layer for meaning, memory, and responsibility above HTML.
- A cognitive kernel (Presence × Memory × Action) that makes decisions and their justifications inspectable.
- LLAT (LifeOS Logical Action Traces) to connect intent, consent, and action over time.

In short:

> **Solid** defines where data lives and who controls access.  
> **The Semantic Web** formalised data, logic, and proof.  
> **LifeOS** extends this stack with memory, explanation, temporal coherence, and human-facing agency.
...
This specification may be cited in academic or technical work. If you do, please use:
